 ...
 * @param in 
   * 
   * @param objects
   *          La collezione degli elementi che devono esser epiazzati in questo
   *          vettore.
   */
 ...
 * @param in */
  public IntegerList(StringList in) {
	...
	/**
	 * Inizializza la lista tipizzata di oggetti partendo da un array di oggetti Integer.
	 * 
	 * @param in
	 *            Integer[] vettore di Integer
	 */
	 ...
	 * 
	 * @param all
	 *            Array contenente tutte gli Integer da aggiungere alla lista
	 */
  ...
  public void sort() {
	...
	/**
	 * Metodo di utilità per determinare se una lista è piena. Il metodo non entra nel merito di controllare se i valori
	 * sono tutti diversi da null.
	 * 
	 * @param list
	...
	/**
	 * Metodo di utilità per determinare se una lista è vuota. Il metodo non entra nel merito di controllare se i valori
	 * sono tutti null.
	 * 
	 * @param list
	 *          La lista da controllare
	...
	/** Converte una la lista di Integer(IntegerList) in una lista di String (StringList)
	 * @return */
	...
	/**Converte la stringa in una DSV (Delimiter-separated values) > stringa a separatore variabile
	 * Invocando il metodo con parametro vuoto "", si ottiene una sequenza numerica senza separatori
	 * Ignora i campi null, non previsti
	 * 
	 * @param sep
	 * @return
	 */
